...
def calculate_agg_features(df, label, X):
    middle_list = calculate_agg_middle_features(df, velocity_median=0.907175, velocity_mean=3.4810868989841435, velocity_05=0.159845, velocity_10=0.196774, velocity_15=0.268630, velocity_25=0.370219, velocity_75=6.870488, velocity_85=8.923313, velocity_90=9.989862, velocity_95=11.374170, velocity_99=13.788220)
...
day_night_col_names = ['bird_id'] + day_col_names +\
...
train_df.to_csv(os.path.join('.','data', 'train_df_day_night_together.csv'), index=False)
...
test_df.to_csv(os.path.join('.','data', 'test_df_day_night_together.csv'), index=False)